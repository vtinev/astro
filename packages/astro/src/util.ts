        ...
        props: {
          page: {
            ...
            url: {
              ...
              next: pageNum === lastPage ? undefined : routeMatch!.generate({ ...params, [paramName]: String(pageNum + 1) }),
              prev: pageNum === 1 ? undefined : routeMatch!.generate({ ...params, [paramName]: !includesFirstPageNumber && pageNum - 1 === 1 ? undefined : String(pageNum - 1) }),
            },
          },
        },
      };
